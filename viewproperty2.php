  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="viewproperty.php">View Properties <span class="caret"></span></a>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="viewproperty.php" class='btn btn-primary'>Show Ratings</a> 
<div class="container">
  <br>
...
while($result=mysqli_fetch_assoc($data))
{
    ...
    <td><img src='data:image/jpeg;base64," . base64_encode($result['property pic']) . "'/></td>
    <td>" . $result['landlord_name'] . "</td>
